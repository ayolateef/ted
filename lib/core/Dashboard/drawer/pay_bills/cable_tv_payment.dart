...
class CableTvPayment extends StatelessWidget {
  const CableTvPayment({super.key});
    ...
    return  Scaffold(
      appBar:  TedAppBar(
        ...
        titleWidget: Column(
          ...
          children: [
            Text( StringResources.cable_tv, style: CustomTextStyles.titleMedium18,),
            5.verticalSpace,
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                            ...
                            children: [
                              Column(
                               ...
                               Container(
                                 ...
                                 child: Row(
                                   children: [
                                     SvgPicture.asset(AssetResources.gotvIcon),
                                     Text('GOTV', style: CustomTextStyles.titleMedium18,)
                                   ],
                                 ),
                               )
                            ],
